public class LinearSearch {
    ...
    public static void main(String[] args) {
        ...
        int target = 30;
        int result = linearSearch(arr, target); // Perform the search
...
Linear Search and Binary Search are two fundamental searching algorithms. 
Linear Search works on any collection, while Binary Search requires the collection to be sorted.
...
3.	Finding Bounds: Used in algorithms like finding the smallest/largest element 
